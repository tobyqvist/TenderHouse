...
K:"ytp-mdx-manual-pairing-popup-dialog",U:{role:"dialog"},S:[{D:"div",K:"ytp-mdx-manual-pairing-popup-dialog-inner-content",S:[{D:"div",K:"ytp-mdx-manual-pairing-popup-title",ba:"Snart er det ikke l\u00e6ngere muligt at oprette forbindelse til dit tv p\u00e5 internettet ved hj\u00e6lp af en kode"},{D:"div",K:"ytp-mdx-manual-pairing-popup-buttons",S:[{D:"button",ka:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],ba:"F\u00e5 flere oplysninger"},{D:"button",ka:["ytp-button","ytp-mdx-manual-pairing-popup-ok"],
...
K:"ytp-mdx-popup-dialog",U:{role:"dialog"},S:[{D:"div",K:"ytp-mdx-popup-dialog-inner-content",S:[{D:"div",K:"ytp-mdx-popup-title",ba:"Du er logget ud"},{D:"div",K:"ytp-mdx-popup-description",ba:"Videoer, du ser, vil muligvis blive f\u00f8jet til afspilningshistorikken for tv'et og f\u00e5 indflydelse p\u00e5 tv-anbefalinger. Afbryd, og log ind p\u00e5 YouTube p\u00e5 en computer for at undg\u00e5 dette."},{D:"div",K:"ytp-mdx-privacy-popup-buttons",S:[{D:"button",ka:["ytp-button","ytp-mdx-privacy-popup-cancel"],
ba:"Annuller"},{D:"button",ka:["ytp-button","ytp-mdx-privacy-popup-confirm"],ba:"Bekr\u00e6ft"}]}]}]});this.i=new g.eM(this,250);this.cancelButton=this.ha("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.ha("ytp-mdx-privacy-popup-confirm");g.L(this,this.i);this.N(this.cancelButton,"click",this.l);this.N(this.confirmButton,"click",this.u)},s7=function(a){g.X.call(this,{D:"div",
...
c=g.W(b,128)?g.UJ("Fejl p\u00e5 $RECEIVER_NAME",c):b.Kb()||g.W(b,4)?g.UJ("Afspilles p\u00e5 $RECEIVER_NAME",c):g.UJ("Tilsluttet $RECEIVER_NAME",c);a.Aa("statustext",c);a.i.show()}else a.i.hide()},t7=function(a,b){g.SQ.call(this,"Afspil p\u00e5",0,a,b);
...
t7.prototype.Mh=function(a){return"cast-selector-receiver"===a?"Medvirkende\u2026":this.Ml[a].name};
